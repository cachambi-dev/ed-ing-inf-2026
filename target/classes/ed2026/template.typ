// template.typ - Plantilla base para Trabajos Prácticos de Estructura de Datos (UNJu - FI)
...
#let tp_doc(
  ...
  show raw.where(block: true): it => block(
    ...
    radius: 4pt,
    text(
      font: ("MesloLGS Nerd Font", "DejaVu Sans Mono", "Liberation Mono", "Hack Nerd Font"),
      size: 8.5pt,
      it
    )
  )
...
#let caja_indicaciones(body) = block(
  ...
  below: 6pt,
  [
    #text(weight: "bold", fill: rgb("#b45309"))[💡 Indicaciones:] \
    #v(2pt)
    #body
  ]
)
...
#let caja_preguntas(body) = block(
  ...
  below: 6pt,
  [
    #text(weight: "bold", fill: rgb("#6d28d9"))[❓ Preguntas sobre el problema:] \
    #v(3pt)
    #body
  ]
)
